...
class MyPlayer:
	...
	def placeRing(self):
		...
		print("Place A New Ring. /n hexagon: ",hexagon,"/n position: ",position)
		hexagon = input('Input hexagon: ')
	...
	def selectRing(self):
		...
		print("Select Ring Number. /n ring_num: ",ring_num)
		ring_num = input('Input hexagon: ')
	...
	def moveRing(self):
		...
		print("Move A Ring. /n hexagon: ",hexagon,"/n position: ",position)
		hexagon = input('Input hexagon: ')
		position = input('Input position: ')
	...
	def removeRowStart(self):
		...
		print("Remove Row Start. /n hexagon: ",hexagon,"/n position: ",position)
		hexagon = input('Input hexagon: ')
		position = input('Input position: ')
	...
	def removeRowEnd(self):
		...
		print("Remove Row End. /n hexagon: ",hexagon,"/n position: ",position)
		hexagon = input('Input hexagon: ')
		position = input('Input position: ')
...
# python client.py 0.0.0.0 10000 MyPlayer.py
